...
class CodeGeneratorServiceImplTest {
    ...
    void testCodeRepository() {
        codeRepository.findAll()
                // cu doOnNext fac actiunea pentru fiecare element din fluxul sursa in momentul in care acesta este emis
                .doOnNext(codeData -> System.out.println(codeData))
                .blockLast(); // Blocheaza executia pana ce fluxul se termina
    }
